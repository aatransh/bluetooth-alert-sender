...
//                                PendingIntent pi=PendingIntent.getActivity(getApplicationContext(), 0, intent,0);
                                ...
                                for(int i = 0;i<list.size();i++)
                                      sms.sendTextMessage(list.get(i), null, "I am in trouble .Please help me asap.\nLongitude: "
...
//                            PendingIntent pi=PendingIntent.getActivity(getApplicationContext(), 0, intent,0);
                            ...
                            sms.sendTextMessage(number, null, "I am in trouble .Please help me asap.\nLongitude: "
                                    + log + ",\n" + "Latitude: " + lat, null,null);
//                            phones.close();
//                        }
//                        cursor.close();
...
//                            Toast.LENGTH_LONG).show();
                    ...
                    if(list.size()>4){
                        editor.putString(ct5, list.get(4));
                    }
                    editor.commit();
                }
